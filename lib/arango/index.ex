defmodule Arango.Index do
  ...
  GET /_api/index
  """
  @spec indexes(String.t) :: Request.t
  ...
  """
  @spec create_fulltext(String.t, String.t, Keyword.t) :: Request.t
  ...
  """
  @spec create_general(String.t, map()) :: Request.t
  ...
  POST /_api/index#geo
  """
  @spec create_geo(String.t, [String.t], Keyword.t) :: Request.t
  ...
  """
  @spec create_hash(String.t, [String.t], Keyword.t) :: Request.t
  ...
  """
  @spec create_persistent(String.t, [String.t], Keyword.t) :: Request.t
  ...
  """
  @spec create_skiplist(String.t, [String.t], Keyword.t) :: Request.t
